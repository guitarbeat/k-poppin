...
//   EDIT THINGS HERE
  ...
  const HEARDLE_GOOGLE_ANALYTICS = "";
...
//   STOP EDITING NOW
  ...
  function Ce(t) {
    let n, r, s = t[0][t[7]].answer + "";
    return {
      c() {
        (n = w("div")), (r = _(s)), M(n, "class", "text-white text-sm");
      },
      m(e, t) {
        g(e, n, t), p(n, r);
      },
