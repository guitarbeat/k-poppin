var app = (function () {
      ...
      b.$on("click", e[5]),
      {
        c() {
          (t = w("div")),
            ...
            M(h, "class", "absolute right-3 top-4 bg-transparent border-none cursor-pointer text-custom-fg"),
  ...
  function un(t) {
    ...
    return {
      c() {
        n = _(
          "You didn't get today's K-pop Boy Group Heardle. Better luck tomorrow!"
        );
      },
      m(e, t) {
        g(e, n, t);
