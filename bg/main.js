var app = (function () {
    ...
    return {
      c() {
        ((t = w('div')),
          ...
          (u = w('div')),
          (u.innerHTML =
            '<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"></path></svg>'),
    ...
    return {
      c() {
        ((n = w('div')),
          ...
          (i = w('div')),
          (i.innerHTML =
            '<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 5L6 9H2v6h4l5 4zM22 9l-6 6M16 9l6 6"></path></svg>'),
          (o = x()),
          (a = w('div')),
          (l = w('p')),
          (l.textContent =
  ...
  function Qe(e) {
    ...
    let A = `${mt(e[11])}`;
    let L = `${mt(
      e[15] ? (e[4].isPrime ? e[8].slice(-1)[0] : e[2].maxAttempts * e[2].attemptInterval) : e[3],
    )}`;
    let N = !e[12] && 1 == e[0] && tt();
      ...
      p(e, s) {
        if (4 & s[0]) {
          ...
          for (n = Array(e[2].maxAttempts + 1), i = s; i < n.length; i += 1)
            (Be(e, n, i), r[i] || ((r[i] = ot()), r[i].c(), r[i].m(t.parentNode, t)));
    ...
    return {
      ...
      p(e, s) {
        if (12 & s[0]) {
          const s = n.length;
          let i;
          for (n = Array(Math.floor(e[3] / e[2].attemptInterval)), i = s; i < n.length; i += 1)
            (ze(e, n, i), r[i] || ((r[i] = at()), r[i].c(), r[i].m(t.parentNode, t)));
          for (i = n.length; i < s; i += 1) r[i].d(1);
          r.length = n.length;
        }
      },
      ...
      var f = function (e, t) {
        return new Promise((n, r) => {
          ...
          return (s = e.data).cache && s.store
            ? n()
            : new Promise((e, n) =>
                'function' == typeof s.src ? s.src(t).then(e, n) : e(s.src),
              ).then((t) => {
                try {
  ...
  var Yn = yt((e, t) => {
    e.exports = (function () {
      ...
      function y(e) {
        if (null == e._isValid) {
          ...
          if (
            (e._strict &&
              (s =
                s && 0 === t.charsLeftOver && 0 === t.unusedTokens.length && void 0 === t.bigHour),
      ...
      function N(e, t, n) {
        var r = `${Math.abs(e)}`;
        var s = t - r.length;
        return (e >= 0 ? (n ? '+' : '') : '-') + (10 ** Math.max(0, s)).toString().substr(1) + r;
      }
      var H =
      ...
      function fe(e, t, n) {
        e.isValid() &&
          ...
          ('FullYear' === t && le(e.year()) && 1 === e.month() && 29 === e.date()
            ? ((n = ce(n)), e._d[`set${e._isUTC ? 'UTC' : ''}${t}`](n, e.month(), Qe(n, e.month())))
        ...
        for (
          ...
          if (
            ...
            this._weekdaysParse[r] ||
              ((i = `^${this.weekdays(s, '')}|^${this.weekdaysShort(s, '')}|^${this.weekdaysMin(
                s,
                '',
              )}`),
        ...
        u(t)
          ...
          : d(t)
            ...
            : 'string' == typeof t
              ? Hn(e)
              : i(t)
                ? ((e._a = h(t.slice(0), (e) => parseInt(e, 10))), Rn(e))
                : o(t)
                  ? Bn(e)
                  : c(t)
                    ? (e._d = new Date(t))
      ...
      function hr(e, t) {
        ...
        return null === s
          ? null
          : 0 === (r = 60 * (n = `${s[s.length - 1] || []}`.match(dr) || ['-', 0, 0])[1] + ce(n[2]))
            ? 0
            : '+' === n[0]
              ? r
              : -r;
        ...
        return function (n, r) {
          ...
          return (
            null === r ||
              ...
              (T(
                t,
                `moment().${t}(period, number) is deprecated. Please use moment().${
                  t
      ...
      function Rr(e) {
        var t = i(e);
        var n = !1;
        return (t && (n = 0 === e.filter((t) => !c(t) && Hr(e)).length), t && n);
      }
      ...
      function lo() {
        ...
        return d
          ? ((e = ue(l / 60)),
            ...
            `${s}P${n ? `${i + n}Y` : ''}${c ? `${i + c}M` : ''}${u ? `${o + u}D` : ''}${
              t || e || l ? 'T' : ''
            }${t ? `${a + t}H` : ''}${e ? `${a + e}M` : ''}${l ? `${a + r}S` : ''}`)
          : 'P0D';
      }
      var uo = or.prototype;
      return (
