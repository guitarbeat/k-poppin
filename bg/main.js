var app = (function () {
  ...
  function h(e, t, n, r) {
    if (e[2] && r) {
      ...
      if ('object' == typeof s) {
        const e = [];
        const n = Math.max(t.dirty.length, s.length);
  ...
  function ee(e, n, i, o) {
    const {
      fragment: a, on_mount: l, on_destroy: u, after_update: c,
    } = e.$$;
    (a && a.m(n, i),
    o
        || G(() => {
  ...
  function ne(e, t) {
    (-1 === e.$$.dirty[0] && (N.push(e), F || ((F = !0), R.then(B)), e.$$.dirty.fill(0)),
  ...
  function ie(e) {
    let t; let n; let r; let
      s;
    const i = e[3].default;
    const o = c(i, e, e[2], null);
    return {
      c() {
        ((t = w('button')),
        o && o.c(),
        ...
        t()
          ...
          : e.forEach(
            ({
              ...
              const r = 'script' === e;
              const i = document.createElement(r ? 'script' : 'link');
              (r
  ...
  function ke(e) {
    let t; let n; let r; let s; let i; let o; let a; let l; let u; let c; let d; let h; let f; let m; let
      v;
    return (
      (i = new ae({
        props: {
      ...
      m.$on('click', e[4]),
      {
        c() {
          ...
          (l = x()),
          (u = w('h1')),
          (u.textContent = 'K-Pop Boy Group Heardle'),
          (c = x()),
          (d = w('div')),
          Q(h.$$.fragment),
          (f = x()),
  ...
  function Me(e) {
    ...
    return {
      ...
      p(e, t) {
        ...
        2 & t
            && d !== (d = `Listen to ${e[1].artist} - ${e[1].title} on SoundCloud`)
            && M(n, 'title', d));
      },
      d(e) {
        (e && y(t), h && h.d(), f && f.d());
  ...
  function De(e) {
    ...
    return {
      ...
      p(e, n) {
        (i !== (i = s(e)) && (o && o.d(1), (o = i && i(e)), o && (o.c(), o.m(t, null))),
        l === (l = a(e)) && u ? u.p(e, n) : (u.d(1), (u = l(e)), u && (u.c(), u.m(r, null))));
      },
      d(e) {
  ...
  function Pe(e) {
    ...
    return {
      ...
      p(e, o) {
        (s === (s = r(e)) && i ? i.p(e, o) : (i.d(1), (i = s(e)), i && (i.c(), i.m(t, n))),
  ...
  function He(e, t, n) {
    ...
    //console.log(t)
    //console.log(n)
    // console.log("welcome to K-Pop Boy Group Heardle, day #", t.currentHeardle.id);
    // console.log("if you have any questions, DM me on twitter at @derekahmedzai");
    let r;
    let { userGuesses: s } = t;
    let { maxAttempts: i } = t;
    let { currentHeardle: o } = t;
    let { todaysGame: a } = t;
    return (
      (e.$$set = (e) => {
  ...
  function Xe(t) {
    ...
    return {
      c() {
        ...
        (s = w('div')),
        (i = w('div')),
        (i.innerHTML = '<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 5L6 9H2v6h4l5 4zM22 9l-6 6M16 9l6 6"></path></svg>'),
        (o = x()),
        (a = w('div')),
        (l = w('p')),
    ...
    return (
      ...
      }),
      {
        ...
        p(n, r) {
          ...
          (!P || 1024 & r[0])
              && (T(a, 'width', `${e[10]}%`), M(i, 'aria-valuenow', `${Math.round(e[10])}`)),
  ...
  function et(e) {
    let t; let n; let r; let s; let i; let
      o;
    return {
      c() {
        ((t = w('p')),
  ...
  function tt(e) {
    ...
    return {
      c() {
        ((t = w('div')),
        (t.innerHTML = '<p>Turn up the volume and tap to start the track!</p> \n\n                <svg aria-hidden="true" class="mt-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"></path></svg>'),
  ...
  function it(e) {
    let t;
    let n = Array(Math.floor(e[3] / e[2].attemptInterval));
    let r = [];
  ...
  function ct(t) {
    ...
    return {
      c() {
        ((n = w('div')),
        (n.innerHTML = '<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 5L6 9H2v6h4l5 4zM22 9l-6 6M16 9l6 6"></path></svg>'),
  ...
  function ft(e) {
    let t; let n; let r; let s; let i; let o; let a; let u; let c; let d; let
      h;
    const f = [Je, Ve];
    const m = [];
  ...
  function mt(e) {
    ...
    var n = ((e % 6e4) / 1e3).toFixed(0);
    return `${t}:${n < 10 ? '0' : ''}${n}`;
  }

  function pt(e, t, n) {
    let r; let s; let i; let o; let a; let l; let
      u;
    const c = A();
    let { currentAttempt: d } = t;
    let { currentHeardle: h } = t;
    let { config: f } = t;
    let { trackDuration: m = 0 } = t;
    let { gameState: p } = t;
    let g = !1;
    var y;
    let v = 0;
    ...
    function T() {
      (y = SC.Widget(`soundcloud${h.id}`)).bind(SC.Widget.Events.READY, () => {
        (y.getCurrentSound((e) => {
        ...
        y.bind(SC.Widget.Events.PAUSE, () => {
          $(!1);
        }),
        y.bind(SC.Widget.Events.PLAY, () => {
          (b
              || (pe('startGame', {
                name: 'startGame',
              }),
        ...
        y.bind(SC.Widget.Events.PLAY_PROGRESS, (e) => {
    ...
    return (
      ...
      (e.$$.update = () => {
        ...
        405 & e.$$.dirty[0]
            && n(16, (l = p.isPrime ? (a[o - 1] / a.slice(-1)[0]) * 100 : (d / f.maxAttempts) * 100)),
    ...
    ((n = function () {
      ...
      function t(t) {
        for (var n = 1; n < arguments.length; n++) {
          ...
          n % 2
            ? e(Object(s), !0).forEach((e) => {
              r(t, e, s[e]);
            })
            : Object.getOwnPropertyDescriptors
              ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(s))
              : e(Object(s)).forEach((e) => {
      ...
      var h = function (e, t, n) {
        ...
        if (((t = t.toString()), (e = u(e, i)), 'loose' === s)) {
          ...
          var d = 0;
          var h = Array.from(t)
            .map((t, n) => (d < l && a[n] === e[d] && ((t = o ? c(t, o) : t), d++), t))
            .join('');
          if (d === l) return h;
        } else {
          var f = a.indexOf(e);
      ...
      var f = function (e, t) {
        return new Promise((n, r) => {
          ...
          return (s = e.data).cache && s.store
            ? n()
            : new Promise((e, n) => ('function' == typeof s.src ? s.src(t).then(e, n) : e(s.src))).then((t) => {
              try {
      ...
      var _ = function (e, t) {
        var n = t.resultItem;
        var r = t.list.getElementsByTagName(n.tag);
        var i = !!n.selected && n.selected.split(' ');
        if (t.isOpen && r.length) {
          ...
          (t.cursor = e),
          l > -1
                  && (r[l].removeAttribute(y), i && (a = r[l].classList).remove.apply(a, s(i))),
      ...
      function M(e, n) {
        ...
        return new Promise((s, i) => {
          ...
          return (
            (o = n
                || ((a = e.input) instanceof HTMLInputElement || a instanceof HTMLTextAreaElement
                  ? a.value
                  : a.innerHTML)),
            (function (e, t, n) {
                ...
                list: {
                  ...
                  click(t) {
                    !(function (e, t) {
                      ...
                      var r = Array.from(t.list.querySelectorAll(n));
  ...
  function Dt(e) {
    let t; let n; let s; let i; let o; let a; let l; let u; let c; let d; let h; let f; let m; let v; let _; let b; let $; let T; let
      Y;
    return (
      (v = new ae({
        props: {
      ...
      b.$on('click', e[5]),
      {
        c() {
          ...
          (d = x()),
          (h = w('button')),
          (h.innerHTML = '<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>'),
          (f = x()),
          (m = w('div')),
          Q(v.$$.fragment),
          (_ = x()),
          ...
          M(h, 'type', 'button'),
          M(h, 'aria-label', 'Clear search'),
          M(
            h,
            'class',
            'absolute right-3 top-4 bg-transparent border-none cursor-pointer text-custom-fg',
          ),
          ...
          data: {
            ...
            filter: (e) => {
              ...
              return (e = e.sort((e, n) => {
                ...
                let s = xt(t, n.value.toLowerCase());
  ...
  function Ct(e) {
    let t; let n; let r; let s; let i; let o; let a; let l; let u; let d; let v; let
      k;
    const b = e[6].default;
    const D = c(b, e, e[5], null);
    return {
      c() {
        ((t = w('div')),
        (n = w('div')),
  ...
  function Pt(e) {
    let t; let n; let s; let i; let o; let a; let l; let u; let
      c;
    const d = [Ot, Ct];
    const h = [];
    ...
    return (
      ...
      (a = h[o] = d[o](e)),
      {
        ...
        m(r, a) {
          ...
          e[7](i),
          (l = !0),
          u || ((c = [S(window, 'keydown', e[4]), S(t, 'click', e[3])]), (u = !0)));
        },
        p(e, [t]) {
          let n = o;
          ((o = f(e)),
        ...
        (e) => {
          if ('Escape' !== e.key) {
            if ('Tab' === e.key) {
              ...
              const n = Array.from(t).filter((e) => e.tabIndex >= 0);
  ...
  function It(t) {
    ...
    return {
      c() {
        ((n = w('div')),
        (r = w('a')),
        (r.innerHTML = '<span class="kofitext svelte-1d3p4dy"><img src="https://storage.ko-fi.com/cdn/cup-border.png" alt="Ko-fi donations" class="kofiimg mr-2 mb-1 svelte-1d3p4dy"/>Support me on Ko-Fi</span><svg xmlns="http://www.w3.org/2000/svg" class="ml-2" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h13M12 5l7 7-7 7"></path></svg>'),
  ...
  function Gt(t) {
    let n; let r; let s; let i; let o; let a; let l; let u; let c; let
      d;
    return {
      c() {
        ((n = w('div')),
  ...
  function jt(e, t, n) {
    ...
    return (
      P(async () => {
        (async function () {
          const e = await fetch('supporters.json');
          return await e.json();
        }()).then((e) => {
          n(0, (r = e.supporters));
        });
  ...
  function zt(t) {
    let n; let r; let s; let i; let o; let a; let l; let u; let
      c;
    return (
      (a = new Rt({})),
      (u = new Bt({})),
      {
        c() {
          ((n = w('p')),
          (s = w('p')),
          (n.innerHTML = 'If you enjoyed the game and would like to support me with server costs to keep the game running, please consider donating!'),
          (r = x()),
          (s = w('p')),
          (s.innerHTML = '<p class="mb-3">If you\'ve enjoyed playing this, then please consider supporting the <a href="https://ko-fi.com/heardle">real Heardle devs</a> and the <a href="https://ko-fi.com/heardlekpop">K-Pop Heardle devs</a> as this project is based on their work.</p>'),
          (i = x()),
          (o = w('div')),
          Q(a.$$.fragment),
          (l = x()),
  ...
  function Zt(e, t, n) {
    let r = '';
    let s = new Date();
    let i = 3600 * (23 - s.getHours()) + 60 * (59 - s.getMinutes()) + (59 - s.getSeconds());

    function o() {
      let e = Math.floor(i / 3600);
      let t = Math.floor((i - 3600 * e) / 60);
    ...
    return (
      ...
      (O = new Rt({})),
      {
        c() {
          ...
          (m = w('div')),
          (k = w('div')),
          (k.textContent = 'Next Boy Group song in:'),
          (b = x()),
          Q(S.$$.fragment),
          (D = x()),
          (T = w('div')),
        ...
        p(e, n) {
          ...
          (I === (I = H(e)) && W ? W.p(e, n) : (W.d(1), (W = I(e)), W && (W.c(), W.m(a, null))),
          e[5] ? R || ((R = cn()), R.c(), R.m(t, u)) : R && (R.d(1), (R = null)));
          const s = {};
          (8192 & n
            && (s.$$scope = {
              dirty: n,
  ...
  function an(e) {
    ...
    let n;
    let r;
    let s = `${(e[0].length * e[1].attemptInterval) / 1e3}`;
    return {
      c() {
        ((t = _("You got today's K-Pop Boy Group Heardle within the first ")),
        (n = _(s)),
        (r = _(' seconds.')));
      },
      m(e, s) {
  ...
  function ln(e) {
    ...
    let s;
    let i;
    let o = `${e[1].attemptIntervalAlt[e[0].length - 1] / 1e3}`;
    let a = e[1].attemptIntervalAlt[e[0].length - 1] / 1e3 > 1 ? 's' : '';
    return {
      c() {
        ((t = _("You got today's K-pop Boy Group Heardle within ")),
        (n = _(o)),
        (r = _('\n                second')),
        (s = _(a)),
        (i = _('.')));
      ...
      p(e, t) {
        ...
        3 & t
            && a !== (a = e[1].attemptIntervalAlt[e[0].length - 1] / 1e3 > 1 ? 's' : '')
            && $(s, a));
      },
      d(e) {
  ...
  function un(t) {
    ...
    return {
      c() {
        n = _("You didn't get today's K-pop Boy Group Heardle. Better luck tomorrow!");
      },
      m(e, t) {
        g(e, n, t);
      },
  ...
  function dn(e) {
    let t; let n; let r; let s; let i; let o; let
      a;
    return {
      c() {
        ((t = _('Share\n                ')),
  ...
  function gn(e) {
    let t; let n; let r; let s; let i; let o; let a; let l; let u; let
      c;
    return (
      (u = new ae({
        props: {
  ...
  function _n(e) {
    ...
    let E;
    let j;
    let B = `${e[6] > 0 ? ((e[8] / e[6]) * 100).toFixed(1) : 0}`;
    let z = `${e[7].slice(-1)[0]}`;
    let U = `${Math.max(...e[7])}`;
    let V = e[9];
    let J = [];
  ...
  function xn(e) {
    ...
    let n;
    let r;
    let s = `${((e[17] + 1) * e[0].attemptInterval) / 1e3}`;
    return {
      c() {
        ((t = _('< ')), (n = _(s)), (r = _('s')));
      },
    ...
    return {
      c() {
        ...
        M(
          ...
          e[17] === e[9].length - 1
            ? `${e[15]} losses`
            : `${e[15]} wins in ${e[17] + 1} guess${0 === e[17] ? '' : 'es'}`,
        ),
      ...
      for (let e in r) {
        !0 === r[e].hasFinished
          ...
          !0 === r[e].gotCorrect
            ...
            : (++p[s.maxAttempts], p[s.maxAttempts] > g && (g = p[s.maxAttempts])));
      }
  ...
  var Yn = yt((e, t) => {
    e.exports = (function () {
      ...
      function y(e) {
        if (null == e._isValid) {
          var t = g(e);
          var r = n.call(t.parsedDateParts, (e) => null != e);
          var s = !isNaN(e._d.getTime())
              && t.overflow < 0
              && !t.empty
              && !t.invalidEra
              && !t.invalidMonth
      ...
      function N(e, t, n) {
        ...
        var s = t - r.length;
        return (
          (e >= 0 ? (n ? '+' : '') : '-') + (10 ** Math.max(0, s)).toString().substr(1) + r
        );
      }
      ...
      function U(e) {
        ...
        return t || !n
          ...
          : ((this._longDateFormat[e] = n
            .match(H)
            .map((e) => ('MMMM' === e || 'MM' === e || 'DD' === e || 'dddd' === e ? e.slice(1) : e))
            .join('')),
      ...
      var Oe = /Z|[+-]\d\d(?::?\d\d)?/gi;
      var Pe = /[+-]?\d+(\.\d{1,3})?/;
      var Ae = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i;
      ...
      Le('M', xe),
      Le('MM', xe, ve),
      Le('MMM', (e, t) => t.monthsShortRegex(e)),
      Le('MMMM', (e, t) => t.monthsRegex(e)),
      Re(['M', 'MM'], (e, t) => {
        t[Be] = ce(e) - 1;
      }),
      Re(['MMM', 'MMMM'], (e, t, n, r) => {
      ...
      function xt(e, t, n, r, s) {
        var i;
        var o;
        var a = 1 + 7 * (t - 1) + ((7 + n - r) % 7) + _t(e, r, s);
        return (
          a <= 0
            ? (o = pt((i = e - 1)) + a)
            : a > pt(e)
      ...
      function bt(e, t, n) {
        ...
        var s;
        var i = _t(e.year(), t, n);
        var o = Math.floor((e.dayOfYear() - i - 1) / 7) + 1;
        return (
          o < 1
      ...
      Le('e', xe),
      Le('E', xe),
      Le('dd', (e, t) => t.weekdaysMinRegex(e)),
      Le('ddd', (e, t) => t.weekdaysShortRegex(e)),
      Le('dddd', (e, t) => t.weekdaysRegex(e)),
      Fe(['dd', 'ddd', 'dddd'], (e, t, n, r) => {
      ...
      var Ht = 'Su_Mo_Tu_We_Th_Fr_Sa'.split('_');
      var It = Ae;
      var Wt = Ae;
      var Rt = Ae;
      ...
      function fn(e) {
        for (var t, n, r, s, i = 0; i < e.length;) {
          for (
            t = (s = hn(e[i]).split('-')).length, n = (n = hn(e[i + 1])) ? n.split('-') : null;
            t > 0;
          ) {
      ...
      function Fn(e) {
        var t; var n; var r; var s; var i; var o; var a; var l; var
          u;
        ...
        r < 1 || r > St(n, i, o)
          ...
          : null != l
            ...
            : ((a = xt(n, r, s, i, o)), (e._a[je] = a.year), (e._dayOfYear = a.dayOfYear)));
      }
        ...
        if (e._f !== r.ISO_8601) {
          if (e._f !== r.RFC_2822) {
            ...
            for (s = B(e._f, e._locale).match(H) || [], t = 0; t < s.length; t++) {
              ((i = s[t]),
              (n = (l.match(Ne(i, e)) || [])[0])
                  && ((o = l.substr(0, l.indexOf(n))).length > 0 && g(e).unusedInput.push(o),
                  (l = l.slice(l.indexOf(n) + n.length)),
                  (c += n.length)),
              R[i]
                ? (n ? (g(e).empty = !1) : g(e).unusedTokens.push(i), Ge(i, n, e))
      ...
      function Bn(e) {
        if (!e._d) {
          var t = se(e._i);
          var n = void 0 === t.day ? t.date : t.day;
          ((e._a = h([t.year, t.month, n, t.hour, t.minute, t.second, t.millisecond], (e) => e && parseInt(e, 10))),
          Rn(e));
        }
      }
      ...
      function Un(e) {
        ...
        return (
          ...
          null === t || (void 0 === n && '' === t)
            ...
            b(t)
              ? new x(kn(t))
              : (d(t) ? (e._d = t) : i(n) ? jn(e) : n ? Gn(e) : Vn(e), y(e) || (e._d = null), e))
        );
      }
        ...
        u(t)
          ...
          : d(t)
            ...
            : 'string' == typeof t
              ? Hn(e)
              : i(t)
                ? ((e._a = h(t.slice(0), (e) => parseInt(e, 10))),
                Rn(e))
                : o(t)
                  ? Bn(e)
                  : c(t)
      ...
      function hr(e, t) {
        ...
        return null === s
          ? null
          : 0
              === (r = 60 * (n = (`${s[s.length - 1] || []}`).match(dr) || ['-', 0, 0])[1] + ce(n[2]))
            ? 0
            : '+' === n[0]
              ? r
              : -r;
      ...
      function vr(e) {
        return (
          this._isUTC
            && (this.utcOffset(0, e), (this._isUTC = !1), e && this.subtract(mr(this), 'm')),
          this
        );
      }
      ...
      function kr(e) {
        return (
          !!this.isValid() && ((e = e ? Kn(e).utcOffset() : 0), (this.utcOffset() - e) % 60 == 0)
        );
      }
      ...
      function Er(e, t) {
        1 === arguments.length
          && (arguments[0]
            ...
            : ((e = void 0), (t = void 0)));
        var n = e || Kn();
        var s = fr(n, this).startOf('day');
        var i = r.calendarFormat(this, s) || 'sameElse';
        var o = t && (Y(t[i]) ? t[i].call(this, n) : t[i]);
      ...
      Le('NNNN', Rs),
      Le('NNNNN', Fs),
      Re(['N', 'NN', 'NNN', 'NNNN', 'NNNNN'], (e, t, n, r) => {
      ...
      Le('GGGGG', De, _e),
      Le('ggggg', De, _e),
      Fe(['gggg', 'ggggg', 'GGGG', 'GGGGG'], (e, t, n, r) => {
        t[r.substr(0, 2)] = ce(e);
      }),
      Fe(['gg', 'GG'], (e, t, n, s) => {
      ...
      function so(e, t) {
        return (
          void 0 !== eo[e]
          && (void 0 === t ? eo[e] : ((eo[e] = t), 's' === e && (eo.ss = t - 1), !0))
        );
      }
      ...
      function io(e, t) {
        ...
        return (
          ...
          'object' == typeof t
            && ((i = { ...eo, ...t }), null != t.s && null == t.ss && (i.ss = t.s - 1)),
      ...
      function lo() {
        ...
        var o;
        var a;
        var l = oo(this._milliseconds) / 1e3;
        var u = oo(this._days);
  ...
  function En(e) {
    let t; let n; let s; let i; let o; let a; let l; let u; let c; let d; let h; let f; let m; let v; let k; let _; let b; let $; let D; let Y; let C; let O; let P; let
      A;
    (G(e[18]),
    (l = new me({
      props: {
    ...
    return {
      c() {
        ...
        (C = x()),
        H && H.c(),
        (An.title = 'K-pop Boy Group Heardle'),
        M(t, 'name', 'description'),
        M(
          t,
          'content',
          'Guess the K-pop Boy Group song from the intro in as few tries as possible',
        ),
